                                ...
                                <form method="POST" action="{{ route('admin.store_product') }}" enctype="multipart/form-data">
                                    ...
                                    <div class="row">
                                        ...
                                        <div class="form-group col-md-5 mt-4">
                                            ...
                                            <input type="text" class="form-control @error('length') is-invalid @enderror" id="length" name="length" value="{{ old('length') }}" required>
                                            @error('length')
                                            <span class="invalid-feedback" role="alert">
                                                <strong>{{ $message }}</strong>
                                            </span>
                                        ...
                                        <div class="form-group col-md-5 mt-4">
                                            ...
                                            <input type="text" class="form-control @error('breadth') is-invalid @enderror" id="breadth" name="breadth" value="{{ old('breadth') }}" required>
                                            @error('breadth')
                                            <span class="invalid-feedback" role="alert">
                                                <strong>{{ $message }}</strong>
                                            </span>
                                        ...
                                        <div class="form-group col-md-5 mt-4">
                                            ...
                                            <input type="text" class="form-control @error('height') is-invalid @enderror" id="height" name="height" value="{{ old('height') }}" required>
                                            @error('height')
                                            <span class="invalid-feedback" role="alert">
                                                <strong>{{ $message }}</strong>
                                            </span>
                                        ...
                                        <div class="form-group col-md-10 mt-4" id="variants-wrapper">
                                            ...
                                            <div class="variant-group">
                                                ...
                                                <div class="row variant-input">
                                                    <div class="col-md-3">
                                                        <input type="text" class="form-control variant-input-field" name="variants[0][name]" placeholder="Variant Name" required>
                                                    </div>
                                                    <div class="col-md-3">
                                                    ...
                                                    <div class="col-md-3 mt-4">
                                                        <input type="text" class="form-control" name="variants[0][stock]" placeholder="Variant Stock" required>
                                                    </div>
                                                    <div class="col-md-12 mt-4">
                                                        <div class="input-group mb-3">
                                                            ...
                                                            <button type="button" class="btn btn-danger remove-variant-btn ml-4">Remove Variant</button>
                                                        </div>
                                                    </div>
                                                </div>
                                            </div>
                                        ...
                                        <div class="form-group col-md-10 mt-4" id="image-wrapper">
                                            ...
                                            <div class="input-group mb-3">
                                                ...
                                                <button type="button" class="btn btn-success add-image-btn" id="add-image-btn">Add More Images</button>
                                            </div>
                                            @error('images')
                                            <span class="invalid-feedback" role="alert">
                                                <strong>{{ $message }}</strong>
                                        ...
                                        <div class="form-group col-md-4 mt-4">
                                            <div class="form-check">
                                                ...
                                                <input type="checkbox" class="form-check-input" id="today_hot_deals" name="today_hot_deals" value="1">
                                        ...
                                        <div class="form-group col-md-4 mt-4">
                                            <div class="form-check">
                                                ...
                                                <input type="checkbox" class="form-check-input" id="best_seller" name="best_seller" value="1">
                                        ...
                                        <div class="form-group col-md-4 mt-4">
                                            <div class="form-check">
                                                ...
                                                <input type="checkbox" class="form-check-input" id="featured_products" name="featured_products" value="1">
...
button" class="btn btn-danger remove-image-btn">Remove</button>
            </div>`;
                        $('#image-wrapper').append(imageInput);
                        imageIndex++;
                    });
