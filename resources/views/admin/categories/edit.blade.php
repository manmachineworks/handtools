                                ...
                                <form action="{{ route('categories.update', $category) }}" method="POST"
                                    ...
                                    <div class="form-group mt-4">
                                        ...
                                        <textarea class="form-control" id="meta_keyword"
                                            name="meta_keyword">{{ $category->meta_keyword }}</textarea>
                                    </div>
                                    <div class="form-group mt-4">
                                    ...
                                    <div class="form-group mt-4">
                                        <label for="cat_image">Blog Image</label>
                                        <input type="file" class="form-control" id="cat_image" name="cat_image">
                                        @if ($category->cat_image)
                                            <img src="/{{ $category->cat_image }}" height="200px" />
                                        @endif
                                    </div>
                                    <div class="form-group mt-4">
                                        <label for="cat_text">Category Text</label>
                                        <textarea class="form-control" id="editor"
                                            name="cat_text">{{ $category->cat_text }}</textarea>
                                    </div>
