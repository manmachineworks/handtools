            ...
            <div class="container-fluid pt-4 px-4">
                <div class="bg-secondary text-center rounded p-4">
                    <div class="d-flex align-items-center justify-content-between mb-4">
                        <h6 class="mb-0">Contact Enquiry Form Details</h6>
                        <!-- <a href="">Show All</a> -->
                    </div>
                    ...
                    <div class="container">
                        ...
                        <div class="card">
                            ...
                            <div class="card-body">
                                ...
                                <p><strong>Phone:</strong> {{ $applyForm->phone }}</p>
                                <p><strong>Subject:</strong> {{ $applyForm->subject }}</p>
                                <p><strong>Product_type:</strong> {{ $applyForm->product_type }}</p>
                                <p><strong>Message:</strong> {{ $applyForm->message }}</p>
