                ...
                <div class="col-md-12">
                    <div class="bg-secondary text-white rounded p-4">
                        ...
                        <form method="GET" class="mb-3">
                            <div class="row g-2">
                                <div class="col-md-4">
                                    <input type="text" name="q" class="form-control" placeholder="Search by name or slug" value="{{ $search }}">
                                </div>
                                <div class="col-md-2">
                                ...
                                @forelse($brands as $brand)
                                    <tr>
                                        ...
                                        <td>
                                            ...
                                            <form action="{{ route('brands.destroy', $brand) }}" method="POST" style="display:inline-block;" onsubmit="return confirm('Delete this brand? This will unassign it from products.');">
                                                @csrf
                                                @method('DELETE')
