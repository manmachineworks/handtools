...
<nav class="navbar navbar-expand bg-secondary navbar-dark sticky-top px-4 py-0 shadow-sm">
    ...
    <a href="{{ url('/') }}" class="navbar-brand d-flex d-lg-none me-4 align-items-center">
        ...
        <span class="ms-2 fw-semibold text-white">Admin</span>
    </a>

    <!-- Sidebar Toggle -->
    <button class="sidebar-toggler flex-shrink-0 btn btn-link text-white p-0"
            type="button"
    ...
    <a href="{{ url('/') }}" class="navbar-brand d-none d-lg-flex align-items-center ms-3">
        ...
        <!--     onerror="this.style.display='none'">-->
        <span class="ms-2 fw-semibold text-white">Gurunanak Hand Tools</span>
    </a>
            ...
            <a href="#"
               ...
               aria-expanded="false">
                <img class="rounded-circle me-2"
                     src="{{ auth()->user()->avatar ?? '/assets/admin/img/user.jpg' }}"
                     alt="Admin Profile"
