                        ...
                        <div class="sec-one-buttons">
                            <a href="{{ url('/contact') }}" class="btn-main btn1">Get A Quote
                                <span class="arrow-section">
                                    <img class="arrow" src="/assets/new_assets/images/svg/right-arrow-svg.svg"
                                        alt="right-arrow-svg">
                                </span>
            ...
            <div class="row">
                ...
                <div class="col-xxl-6 col-xl-6 col-lg-6">
                    ...
                    <p class="fusce fade_down">
                        ...
                        requirements, we provide a wide range of products backed by trusted brands and dependable
                        support.
                    </p>
                    ...
                    <div class="row highQulity-box-row overflow-hidden">
                        ...
                        <p class="semper blandit">
                            ...
                            our catalog is designed to cover every essential requirement with reliable supply and
                            support.
                        </p>
            ...
            <div class="container">
                <div class="row justify-content-between align-items-end">
                    <div class="col">
                        ...
                        <div class="handyman-services-textMain">
                            ...
                            <p class="fusce malesuada fade_down mt-0">
                                Find the right tool for every job — explore our most popular categories and shop with
                                confidence.
                            </p>
                        </div>
                    </div>
                    ...
                    <div class="col-sm-auto">
                        <div class="icon-box">
                            <button data-slick-prev=".services_slider" class="slick-arrow default"
                                aria-label="Previous category">
                                <i class="fas fa-arrow-left"></i>
                            </button>
                            <button data-slick-next=".services_slider" class="slick-arrow default"
                    ...
                    @foreach($categories as $category)
                        <a href="{{ route('category.show', $category->slug) }}">
                            <div class="services-slider-box">
                                <img class="services-icon" src="{{ asset($category->cat_image) }}" alt="{{ $category->name }}"
...
==============================-->
    ...
    <section class="portfolio-area-1 space overflow-hidden">
                ...
                <div class="col-xl-5 col-lg-6">
                    <div class="title-area">
                        ...
                        <h2 class="sec-title">
                            ...
                            <img class="title-bg-shape" src="/assets/assets/img/bg/title-bg-shape.avif" loading="lazy"
                                decoding="async" alt="Products">
                        </h2>
                    </div>
                </div>
                @if($hasProducts)
                    <div class="col-sm-auto">
                        <div class="title-area">
                            <div class="icon-box">
                                <button data-slick-prev=".portfolio-slider1" class="slick-arrow default"
                                    aria-label="Previous products">
                                    <i class="fas fa-arrow-left"></i>
                                </button>
                                <button data-slick-next=".portfolio-slider1" class="slick-arrow default"
        ...
        @if($hasProducts)
            <div class="container-fluid p-0">
                <div class="row global-carousel gx-30 portfolio-slider1" data-slide-show="3" data-lg-slide-show="2"
                    ...
                    data-center-padding="150px" data-xl-center-padding="100px" data-ml-center-padding="80px"
                    data-lg-center-padding="60px" data-md-center-padding="40px" data-sm-center-padding="30px">
                        ...
                        <div class="col-lg-6 ">
                            <div class="portfolio-card style2">
                                <div class="portfolio-card-thumb">
                                    ...
                                    <a href="{{ $productLink }}" class="thumb-link">
                                        <img src="{{ $imagePath }}" loading="lazy" decoding="async"
                                            alt="{{ $product->product_name ?? 'Product image' }}" class="thumb-img">
                                    </a>
                                </div>
                                ...
                                <div class="portfolio-card-details">
                                    <div class="media-left">
                                        ...
                                        @endphp
                                        <h3 class="portfolio-card-details_title clamp-titlee2">
                                    ...
                                    <a href="{{ $productLink }}" class="icon-btn"
                        ...
                        <div class="portfolio-card style2">
                            <div class="portfolio-card-details">
                                <div class="media-left">
                                    ...
                                    <span class="portfolio-card-details_subtitle">We are updating our catalog. Reach out for
                                        a tailored quote.</span>
                                </div>
    ...
    <style>
        ...
        .portfolio-card-thumb .thumb-link {
            position: relative;
            display: block;
            width: 100%;
            aspect-ratio: 1 / 1;
        ...
        .portfolio-card-thumb .thumb-img {
            width: 100%;
            height: 100%;
            object-fit: cover;
            /* crops to square */
        ...
        .portfolio-card-thumb .thumb-link::after {
            content: "";
            position: absolute;
            inset: 0;
        ...
        .portfolio-card-thumb .thumb-link:hover::after {
            opacity: 0.85;
        }
    ...
    <style>
        ...
        .tool-wheel .circle-item {
            position: absolute;
            inset: 0;
            animation: wheel-spin 38s linear infinite;
        }

        .tool-wheel .circle-item>li {
            position: absolute;
            left: 50%;
            top: 50%;
        ...
        .tool-wheel .circle-item>li:nth-child(1) {
            transform: rotate(0deg) translate(16em);
        }

        .tool-wheel .circle-item>li:nth-child(2) {
            transform: rotate(45deg) translate(16em);
        }

        .tool-wheel .circle-item>li:nth-child(3) {
            transform: rotate(90deg) translate(16em);
        }

        .tool-wheel .circle-item>li:nth-child(4) {
            transform: rotate(135deg) translate(16em);
        }

        .tool-wheel .circle-item>li:nth-child(5) {
            transform: rotate(180deg) translate(16em);
        }

        .tool-wheel .circle-item>li:nth-child(6) {
            transform: rotate(225deg) translate(16em);
        }

        .tool-wheel .circle-item>li:nth-child(7) {
            transform: rotate(270deg) translate(16em);
        }

        .tool-wheel .circle-item>li:nth-child(8) {
            transform: rotate(315deg) translate(16em);
        }

        .tool-wheel .circle-item>li.last {
            left: 50%;
            top: 50%;
                        ...
                        <div class="input-main">
                            ...
                            <div class="wrapper">
                                <div class="formDropDown">Choose Category*
                                    <img class="arrow-icon-form" src="/assets/new_assets/images/svg/down-arrow.svg"
                                        alt="arrow-icon-form">
                                </div>
                        ...
                        <ul class="circle-item">
                            ...
                            <li title="Hook Wrench">
                                <a href="#">
                                    <img src="https://deneerstools.com/wp-content/uploads/2020/06/Hook-wrench-300x300.png"
                                        alt="Hook Wrench" width="151" height="151" loading="lazy">
                                </a>
                            </li>
                            ...
                            <li title="Bucket Grease Pump with Trolley">
                                <a href="#">
                                    <img src="https://deneerstools.com/wp-content/uploads/2020/06/Bucket-grass-pump-with-trolly-300x300.png"
                                        alt="Bucket Grease Pump with Trolley" width="154" height="154" loading="lazy">
                                </a>
                            </li>
                            ...
                            <li title="Water Pump Plier Box Joint">
                                <a href="#">
                                    <img src="https://deneerstools.com/wp-content/uploads/2020/06/Water-pump-plier-box-joint-300x300.png"
                                        alt="Water Pump Plier" width="153" height="153" loading="lazy">
                                </a>
                            </li>
                            ...
                            <li title="Torque Wrench">
                                <a href="#">
                                    <img src="https://deneerstools.com/wp-content/uploads/2020/06/Torque-wrench-300x300.png"
                                        alt="Torque Wrench" width="150" height="150" loading="lazy">
                                </a>
                            </li>
                            ...
                            <li title="Flat File (Bastard)">
                                <a href="#">
                                    <img src="https://deneerstools.com/wp-content/uploads/2020/06/mini-flat-file.png"
                                        alt="Flat File" width="142" height="142" loading="lazy">
                                </a>
                            </li>
                            ...
                            <li title="Bolt Cutter">
                                <a href="#">
                                    <img src="https://deneerstools.com/wp-content/uploads/2020/06/Bolt-Cutter-300x300.png"
                                        alt="Bolt Cutter" width="157" height="157" loading="lazy">
                                </a>
                            </li>
                            ...
                            <li title="Pipe Bender">
                                <a href="#">
                                    <img src="https://deneerstools.com/wp-content/uploads/2020/06/Pipe-bender-300x300.png"
                                        alt="Pipe Bender" width="157" height="157" loading="lazy">
                                </a>
                            </li>
                            ...
                            <li title="Four Way Wheel Spanner">
                                <a href="#">
                                    <img src="https://deneerstools.com/wp-content/uploads/2020/06/6.png"
                                        alt="Four Way Wheel Spanner" width="155" height="155" loading="lazy">
                                </a>
                            </li>
                            ...
                            <li class="last" title="Trusted Tool Solutions">
                                <div class="center-logo">
                                    <img src="/assets/new_assets/images/svg/parts-img1x1.png" alt="Brand Logo"
                                        loading="lazy">
                                </div>
                                ...
                                <div class="circleEffect rotate">
                                    <svg viewBox="0 0 862 846">
                                        <defs>
                                            <linearGradient id="SVGID_1_" gradientUnits="userSpaceOnUse" x1="355.55"
                                                y1="217.5" x2="844.86" y2="217.5">
                                        ...
                                        <path d="M834.3 419c-5.7 0-10.4-4.5-10.6-10.3
                                         ...
                                         .1 6-4.6 10.9-10.6 10.9z" fill="url(#SVGID_1_)" />
            ...
            <div class="row step-box-row">
                ...
                <div class="col-xxl-3 col-xl-3 col-lg-6 col-md-6">
                    <div class="steps-box-main flip_left">
                        ...
                        <div class="steps-box">
                            <div class="register-img-main">
                                <img class="register" src="/assets/new_assets/images/svg/workProcess.svg"
                                    alt="workProcess">
                            </div>
                    ...
                    <div class="img-group-estimate-main">
                        ...
                        <div class="img-wrapper">
                            <img class="estimate-img img-animation-style1 reveal"
                                src="/assets/new_assets/images/home-page/estimate-img12.jpg"
                                alt="Best Selling Hand Tools">
                        ...
                        <div class="img-group-estimate2">
                            ...
                            <div class="img-wrapper">
                                <img class="img-animation-style4 reveal"
                                    src="/assets/new_assets/images/home-page/estimate-img22.jpg"
                                    alt="Power Tools & Machinery">
                                <div class="overlay"></div>
                                <div class="overlay-text">
                            ...
                            <div class="img-wrapper">
                                <img class="img-animation-style2 reveal"
                                    src="/assets/new_assets/images/home-page/estimate-img33.jpg"
                                    alt="Welding & Workshop Solutions">
                                <div class="overlay"></div>
                                <div class="overlay-text">
                            ...
                            <div class="blog-card style2">
                                <div class="blog-img">
                                    <a href="{{ url('/blog/' . $blog->url) }}">
                                        <img src="{{ asset($blog->blog_image) }}" loading="lazy" decoding="async"
                                            alt="{{ $blog->blog_title }}" width="410" height="300">
                                    </a>
                                </div>
                    ...
                    <div class="accordion" id="accordionExample">
                        <div class="accordion-item">
                            ...
                            <div id="collapseOne" class="accordion-collapse collapse show" aria-labelledby="headingOne"
                                ...
                                <div class="accordion-body">
                                    Yes. We focus on reliable brands and genuine supply for professional and industrial
                                    use.
                        ...
                        <div class="accordion-item">
                            ...
                            <div id="collapseTwo" class="accordion-collapse collapse" aria-labelledby="headingTwo"
                                data-bs-parent="#accordionExample">
                                <div class="accordion-body">
                                    Yes. We support bulk enquiries and repeat procurement. Send your requirement list
                                    and
                        ...
                        <div class="accordion-item">
                            ...
                            <div id="collapseFive" class="accordion-collapse collapse" aria-labelledby="headingFive"
                                data-bs-parent="#accordionExample">
                                <div class="accordion-body">
                                    Yes. Share your application (work type, material, usage frequency), and we’ll
                                    recommend
