                ...
                <div class="left-column">
                        ...
                        <div class="main-slideshow">
                            @foreach($galleryImages as $index => $image)
                                <div class="slide {{ $index === 0 ? 'active' : '' }}">
                                    <img src="{{ asset($image->image_url) }}" loading="lazy" decoding="async"
                    ...
                    <style>
                        ...
                        .center-wrapper {
                            ...
                            /* center horizontally */
                            align-items: center;
                            /* full height of viewport, adjust as needed */
                        }

                        .cut-gloss-section {
                            text-align: center;
                            /* center text and content inside */
                        }
...
==============================-->
                        ...
                        <div class="col-lg-12">
                            <div class="download-list">
                                <div class="download-item d-flex align-items-center justify-content-between">
                                    ...
                                    <a class="download-btn btn btn-primary"
                                        href="{{ asset('assets/download/' . $variant->varaint_name) }}" download>
    ...
    <div class="portfolio-area-1  space-bottom overflow-hidden">
            ...
            <div class="row justify-content-between align-items-end">
                <div class="col-xl-5 col-lg-6">
                    <div class="title-area">
                        ...
                        <h2 class="sec-title">Related products<img class="title-bg-shape"
                                src="/assets/assets/img/bg/title-bg-shape.png" loading="lazy" decoding="async"
                                alt="img"></h2>
                    </div>
                </div>
                        ...
                        <div class="title-area">
                            <div class="icon-box">
                                <button data-slick-prev=".portfolio-slider1" class="slick-arrow default"
                                    aria-label="Previous related"><i class="fas fa-arrow-left"></i></button>
                                <button data-slick-next=".portfolio-slider1" class="slick-arrow default"
                                    aria-label="Next related"><i class="fas fa-arrow-right"></i></button>
                            </div>
                        </div>
                    </div>
                @endif
        ...
        @if(($relatedProducts ?? collect())->count() > 0)
            <div class="container-fluid p-0">
                <div class="row global-carousel gx-30 portfolio-slider1" data-slide-show="3" data-center-mode="true"
                    ...
                    @foreach($relatedProducts as $related)
                            ...
                            'url' => $related->url
                                                ...
                                                <img src="{{ $relatedImage }}" loading="lazy" decoding="async"
                                                    alt="{{ $related->product_name }}" class="thumb-img">
                                            </a>
                                        </div>
    ...
    <style>
        /* 1:1 square thumb */
        .portfolio-card.style2 .portfolio-card-thumb .thumb-link {
            position: relative;
            display: block;
            width: 100%;
            aspect-ratio: 1 / 1;
        ...
        /* image fills square */
        .portfolio-card.style2 .portfolio-card-thumb .thumb-img {
            width: 100%;
            height: 100%;
            object-fit: cover;
            display: block;
        ...
        /* gradient overlay */
        .portfolio-card.style2 .portfolio-card-thumb .thumb-link::after {
            content: "";
            position: absolute;
            inset: 0;
        ...
        /* optional hover */
        .portfolio-card.style2:hover .portfolio-card-thumb .thumb-link::after {
            opacity: 0.85;
        }
    </style>
